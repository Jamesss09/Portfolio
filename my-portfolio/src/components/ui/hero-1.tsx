  ...
  return (
    ...
    >
      ...
      <div
        ...
        dark:bg-[linear-gradient(to_right,#3B2050_1px,transparent_1px),linear-gradient(to_bottom,#3B2050_1px,transparent_1px)]
        bg-[size:6rem_5rem]
      ...
      <div
        ...
        dark:bg-[radial-gradient(closest-side,#6D28D9_85%,transparent)]
        dark:border-[#8B5CF6]
        animate-fade-up"
      />
      ...
      {eyebrow && (
        <a href="#" className="group">
          <span
            ...
            border-[2px] border-gray-300/20 dark:border-white/10
