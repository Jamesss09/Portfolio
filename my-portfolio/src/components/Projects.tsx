        ...
        <div className="grid gap-6">
          {projects.map((project, index) => (
            <motion.article
              ...
              className="bg-bg-card border border-border rounded-2xl shadow-xl overflow-hidden relative max-w-3xl mx-auto"
            >
              <div className="grid md:grid-cols-2">
                {/* Project image — fills the left half on desktop; stacks on top (16:9) on mobile */}
                <a
                  href={project.repo}
                  target="_blank"
                ...
                >
                  <img
                    ...
                    className="h-full w-full object-cover max-md:aspect-video transition-transform duration-500 group-hover:scale-105"
                  />
